...
<head>
    ...
    <title>BuzzOffs | SAST Tool</title>
...
<body class="is-boxed">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">BuzzOffs</h1>
	                        <p class="is-revealing"><span class="typing" style="color:#3ce0ff; font-size: 1.1rem;"></span></p>
							<div class="hero-form field field-grouped is-revealing">            
	                            <div class="control">
	                                <a class="button button-primary button-block" href="login.php">Let's Start</a>
	                            </div>
	                        </div>
						</div>
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Vulnerability Detection</h4>
									</div>
	                                <p class="text-sm mb-0">Our SAST tool scans your code for vulnerabilities like hard-coded credentials, input validation issues, SQL injection, and improper authentication, helping you catch security risks early in development.</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Mitigations and Suggestions</h4>
									</div>
	                                <p class="text-sm mb-0">When vulnerabilities are detected, our tool provides clear mitigations and suggestions. You’ll receive advices on how to address each issue. Our tool guides you toward secure coding practices.</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Dashboard Insights</h4>
									</div>
	                                <p class="text-sm mb-0">Our dashboard provides an intuitive interface to view scan results, highlighting problematic code sections, line numbers, and snippets. This helps developers make informed decisions and prioritize security fixes.</p>
	                            </div>
	                        </div>
						</div>
                    </div>
        ...
        <footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="footer-copyright">&copy; 2024 BuzzOffs, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
    ...
    <script type="text/javascript">
    	var typed = new Typed('.typing',{
	      strings: ["Our SAST tool detects up to 4 vulnerabilities", "Upload your file and wait a few seconds...", "Instantly see if your file is vulnerability-free!"],
	      loop: true,
	      typeSpeed: 30,
	      backSpeed: 30
	    });
